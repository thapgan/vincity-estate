        ...
        return (
            <div className='overview-slick'>
                <Slider {...this.props.settings}>
                    <div>
                        <h2 className="slide-heading text-center overview-heading">Tổng quan về Vincity Ocean Park</h2>
                        <p className="slide-content overview-content">Vincity Ocean Park là một Đại đô thị được VinGroup dựa trên ý tưởng về thành phố sinh thái (Forest City) và xây dựng theo tiêu chuẩn Singapore. Vincity Ocean Park tọa lạc ở ngoại ô Hà Nội với tổng diện tích 420 ha sánh ngang diện tích với Quận Hoàn Kiếm, được quy hoạch chuẩn, các khu nhà biệt thự, khu nhà chung cư cao tầng, xen kẽ với các hệ thống tiện ích hiện đại từ giáo dục tới y tế, các trung tâm thương mại, trung tâm thể thao và giải trí. Điểm đặc biệt ở Vincity Ocean Park là diện tích rộng lớn, với tiêu chuẩn cây xanh, hồ nước lý tưởng (<b>420ha thì có tới hơn 100ha cho cảnh quan, cây xanh, hồ nước</b>) tạo nên một thành phố sinh thái thực sự, đẳng cấp bậc nhất Hà Nội.</p>
                        <div className="col2">                      
                            <ul className="info-list">
                                <li><strong>Tên dự án:</strong> Vincity Ocean Park</li>
                                ...
                                <li><strong>Quy mô dự án:</strong> 420 ha <i>(hơn 100 ha cho cảnh quan, cây xanh, hồ nước)</i></li>
                    ...
                    <div>
                        <h2 className="slide-heading text-center overview-heading">Vị trí dự án Vicity Ocean Park</h2>
                    ...
                    <div>
                        <h2 className="slide-heading text-center overview-heading">Mặt bằng quy hoạch dự án Vincity Ocean Park</h2>
                        <div className="col2">
                            <p className="slide-content overview-content">
                                Vincity Ocean Park với diện tích rộng lớn hơn 400ha được quy hoạch với tỉ lệ cây xanh, sông, hồ hợp lý nhằm tạo nên một hệ sinh thái xanh, sạch, một forest city đẳng cấp. Mặc dù được quy hoạch với nhiều công trình tiện ích và hệ sinh thái xanh, nhưng Vincity Ocean Park vẫn được quy hoạch để nhắm tới tầng lớp trung lưu nhờ sự xen kẽ hài hòa giữa những chung cư cao tầng với nhiều mức giá, kích cỡ khác nhau và những khu biệt thự. Những công trình quy hoạch nổi bật của Vincity Ocean Park:
                            </p>
                            <ul className="info-list">
                                <li>Chung cư cao tầng Ocean Park</li>
